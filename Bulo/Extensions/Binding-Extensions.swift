...
extension Binding {
    /// Ensures that whenever a binding's value is changed, some handler method can be called while
    /// still ensuring that reading and writing of the binding's value can continue.
